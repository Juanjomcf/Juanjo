...
while sw == 0:
    ...
    try:
        ...
        if op == 1:
            ...
            por1 = cont_niño * 100/ cantidad_entradas
            por2 = cont_joven * 100/ cantidad_entradas
            por3 = cont_adulto * 100/ cantidad_entradas
            print("Categoria niño")
            print("------------------")
            print(f"entradas vendidas de niños = {cont_niño}") 
            print(f"monto vendido de entradas para niños = {acum_niño}")
            print(f"porcentaje de entradas niño = {int(por1)}%")
            print()
            print("Categoria joven")
            print("------------------")
            print(f"entradas vendidas de jovenes = {cont_joven}")
            print(f"monto reacudado de entradas joven = {acum_joven}")
            print(f"porcentaje de entradas joven = {int(por2)}%")
            print("Categoria adulto")
            print("------------------")
            print(f"entradas vendidas de adulto = {cont_adulto}")
            print(f"monto reacudado de entradas adulto= {acum_adulto}")
            print(f"porcentaje de entradas adulto = {int(por3)}%")
            print()
            print(f"ventas totales de entrada = {cantidad_entradas}")
            print(f"total de monto recaudado = {total_ventas}")
